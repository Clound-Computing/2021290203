...
def load_dataset(name):
    ...
    if name == 'AG':
        ...
        df1 = pd.read_csv('datasets/datasets/AG_news/train.csv', header=None, index_col=None)
        df2 = pd.read_csv('datasets/datasets/AG_news/test.csv', header=None, index_col=None)
    ...
    if name == 'DBP':
        num_classes = 14
        df1 = pd.read_csv('datasets/datasets/DBPedia/train.csv', header=None, index_col=None)
        df2 = pd.read_csv('datasets/datasets/DBPedia/test.csv', header=None, index_col=None)
        df1.columns = ['label', 'title', 'content']
        df2.columns = ['label', 'title', 'content']
        df = pd.concat([df1, df2])
        label_groups = []
